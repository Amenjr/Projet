 ...
 function SignUp() {
  ...
  return (
    ...
    <FormControl variant="standard"style={{height:"80px"}}>
      ...
      <Button variant="contained" style={{width:"200px",marginLeft:"50px",height:"60px",marginTop:"20px",borderRadius:"15px"}} onClick={(e)=>{e.preventDefault(); dispatch(register({name,email,password,pic,desc},Navigate))}}>Sign Up</Button>
    </Box>
    </div>
  );
}
